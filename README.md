...
Biological scientist transitioning from academia to industry. My research background spans bioinformatics, statistical modeling, and data analysis applied to biological systems — from microbial lipid metabolism to environmental metagenomics. I combine rigorous scientific methodology with computational tools to extract actionable insights from complex biological datasets.
